...
namespace NetFrame.Infrastructure.Repositories
{
    ...
    public class NotificationRepository : BaseRepository<NotificationEntity>, INotificationRepository
    {
        ...
        public override List<long> Add(IEnumerable<NotificationEntity> entities)
        {
        ...
        public override long Add(NotificationEntity entity)
        {
            if (entity == null)
        ...
        public override void Update(NotificationEntity entity)
        {
            if (entity == null)
                throw new ArgumentNullException("entity");
