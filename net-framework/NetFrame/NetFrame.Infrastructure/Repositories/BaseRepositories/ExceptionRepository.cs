...
namespace NetFrame.Infrastructure.Repositories
{
    ...
    public class ExceptionRepository : BaseRepository<ExceptionEntity>, IExceptionRepository
    {
        ...
        public override List<long> Add(IEnumerable<ExceptionEntity> entities)
        {
        ...
        public override long Add(ExceptionEntity entity)
        {
            if (entity == null)
        ...
        public override void Update(ExceptionEntity entity)
        {
            if (entity == null)
